...
fun LoginScreen(onLogin: () -> Unit, onRegister: () -> Unit, onForgotPassword: () -> Unit) {
    ...
    Scaffold(
        // alternativa a toast, pero poco eficiente para el objetivo de la app
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.lumina_transparente),
                contentDescription = "Logo Lumina2",
                modifier = Modifier
            ...
            Spacer(modifier = Modifier.height(10.dp)) // Espacio debajo de la imagen

            // titulo de la app
            Text("Luminar", style = MaterialTheme.typography.headlineMedium)
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    ...
                    passwordError =
                        validarPassword(it) // Valida requisitos de seguridad inmediatamente
                },
            ...
            Button(
                ...
                onClick = {
                    ...
                    emailError =
                        validarEmail(email)       // Valida formato y contenido del email
                    passwordError =
                        validarPassword(password) // Valida requisitos de la contraseña
                    ...
                    if (emailError.isEmpty() && passwordError.isEmpty()) {
                        ...
                        scope.launch {
                            if (puedeIngresar) {
                                ...
                                // no se puede personalizar su tamaño que resulta poco practico
